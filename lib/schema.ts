...
export class CookBook {
  ...
  private _setup: CookBookCallback | undefined;
  ...
  async setup(options: shell.CallOptions): Promise<void> {
    const fn = this._setup;
    if (fn) {
      await fn(options);
    }
  }
